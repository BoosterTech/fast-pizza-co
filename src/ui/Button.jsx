...
const Button = ({ children, disabled, to, type = "primary", onClick }) => {
  ...
  const styles = {
    ...
    secondary:
      "px-4 py-2.5 text-sm md:px-6 md:py-3.5 inline-block border-2 border-stone-300 rounded-full bg-transparent font-semibold uppercase tracking-wide text-stone-400 transition-colors duration-300 hover:text-stone-800 focus:text-stone-800hover:bg-stone-300 focus:outline-none focus:ring focus:ring-stone-200  focus:ring-offset-2 disabled:cursor-not-allowed ",
